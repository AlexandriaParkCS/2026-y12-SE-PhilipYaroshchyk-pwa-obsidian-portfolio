...
```mermaid
---
title: Level 1 Data Flow Diagram (Transaction and Financial Goal Entry)
---
flowchart
...
AuthorisedUser -- Transactions (Income and Expenses) --> DataEntry
DataEntry -- Insert --> Database
```
